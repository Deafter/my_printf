/*
** printf__lib.c for pritnf in /home/lombar_e/PSU/PSU_2016_my_printf/src
**
** Made by Thomas Lombard
** Login   <lombar_e@epitech.net>
**
** Started on  Fri Nov 18 11:32:22 2016 Thomas Lombard
** Last update Sun Nov 20 10:57:13 2016 Thomas Lombard
*/
		      ...
		      t_printf_out	*out)
{
  if (out->print_len <= 0)
    return ;
  if (out->out == e_write || out->out == e_fd)
    write(out->fd, &c, 1);
  else if (out->out == e_fs)
    fwrite(&c, 1, 1, out->fs);
