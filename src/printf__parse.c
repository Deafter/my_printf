/*
** printf__parse.c for printf in /home/lombar_e/PSU/PSU_2016_my_printf/src
**
** Made by Thomas Lombard
** Login   <lombar_e@epitech.net>
**
** Started on  Fri Nov 18 14:25:15 2016 Thomas Lombard
** Last update Sat Nov 19 19:54:24 2016 Thomas Lombard
*/
...
bool			printf__parse(char		**format,
				      ...
				      t_printf_out	*out)
{
  static t_printf_func	funcs[PRINTF_SUPPORT_LEN + 1] = {{0}};
  t_printf_param	p;
  int			i;
